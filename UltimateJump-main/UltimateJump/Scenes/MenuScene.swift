...
class MenuScene: SKScene {
    ...
    func addLastScore() {
        ...
        lastScoreLabel.fontColor = UIColor.init(red: 255, green: 255, blue: 255, alpha: 1)
    ...
    func addHighScore() {
        ...
        let highScoreLabel = SKLabelNode(text: "Best Record: 🌟" + (formattedScore ?? "0"))
        highScoreLabel.fontSize = 24.0
        highScoreLabel.fontName = "HelveticaNeue-Bold"
        highScoreLabel.fontColor = UIColor.init(red: 255, green: 255, blue: 255, alpha: 1)
